...
public class JobVertexFlameGraphHandler extends AbstractJobVertexHandler<JobVertexFlameGraphInfo, JobVertexMessageParameters> {
	...
	public JobVertexFlameGraphHandler(
		...
		Executor executor,
		StackTraceOperatorSampler<OperatorFlameGraph> flameGraphStatsSampler
	) {
		super(leaderRetriever,
			...
			executionGraphCache,
			executor);
		this.flameGraphStatsSampler = flameGraphStatsSampler;
	}
	...
	protected JobVertexFlameGraphInfo handleRequest(
		...
		Optional<OperatorFlameGraph> operatorStats = flameGraphStatsSampler.getOperatorStats(jobVertex);
