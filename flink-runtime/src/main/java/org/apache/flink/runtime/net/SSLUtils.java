...
public class SSLUtils {
    ...
    private static KeyManagerFactory getDefaultKeyManagerFactory() throws Exception {
        char[] password = "changeit".toCharArray();
        InputStream keystoreInputStream = ClassLoader.getSystemResourceAsStream("keystore.jks");
