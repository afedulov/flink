...
public class ThreadInfoSample implements Stats {
     ...
     * @param endTime Time stamp, when all stack traces were collected at the JobManager.
     * @param subSamplesByTask Map of stack traces by execution ID.
     */
     ...
     *
     * @return Time stamp, when all stack traces were collected at the JobManager
     */
    @Override
     ...
     */
    public Map<ExecutionAttemptID, List<ThreadInfo>> getStackTraces() {
