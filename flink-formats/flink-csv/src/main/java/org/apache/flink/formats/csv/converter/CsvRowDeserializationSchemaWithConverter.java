 ...
 */
@PublicEvolving
public final class CsvRowDeserializationSchemaWithConverter implements DeserializationSchema<Row> {
    ...
    private CsvRowDeserializationSchemaWithConverter(
            RowTypeInfo typeInfo, CsvSchema csvSchema, boolean ignoreParseErrors, ConverterRegistry converters) {
    ...
    /** A builder for creating a {@link CsvRowDeserializationSchemaWithConverter}. */
    @PublicEvolving
    public static class Builder {
         ...
         * parameters.
         */
        public Builder(TypeInformation<Row> typeInfo, ConverterRegistry converters) {
            Preconditions.checkNotNull(typeInfo, "Type information must not be null.");
            Preconditions.checkNotNull(converters, "Type converters registry must not be null.");
        ...
        public CsvRowDeserializationSchemaWithConverter build() {
            return new CsvRowDeserializationSchemaWithConverter(typeInfo, csvSchema, ignoreParseErrors, converters);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        final CsvRowDeserializationSchemaWithConverter that = (CsvRowDeserializationSchemaWithConverter) o;
